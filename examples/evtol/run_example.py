#!/usr/bin/env python3
"""
eVTOL Example — Run Script

Demonstrates AEROSPACEMODEL for electric VTOL aircraft programs.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Run eVTOL example")
    ...
    parser.add_argument("--baseline", default="FBL-SL2-2026-Q1", help="Baseline ID")
    args = parser.parse_args()
    
    print("=" * 70)
    print("AEROSPACEMODEL — eVTOL Example")
    print("Program: SkyLift-200 (SL2)")
    print("Type: Electric Vertical Take-Off and Landing")
    print("=" * 70)
    print()
    ...
    contracts = {
        "SL2-CTR-AMM-001": {
            ...
            "scope": "ATA 24, 27, 45, 70, 71"
        },
        "SL2-CTR-CMM-001": {
            "name": "Component Maintenance Manual - Battery",
            "baseline": "FBL-SL2-2026-Q1",
            "scope": "Battery Pack Assembly"
        }
    }
    ...
    if args.contract:
        ...
        print()
        print("Usage:")
        print("  python run_example.py --contract SL2-CTR-AMM-001")
