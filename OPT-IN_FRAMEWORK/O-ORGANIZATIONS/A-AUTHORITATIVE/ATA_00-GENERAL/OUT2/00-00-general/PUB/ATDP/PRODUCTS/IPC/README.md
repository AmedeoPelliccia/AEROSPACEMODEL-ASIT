# ATDP / PRODUCTS / IPC — Illustrated Parts Catalog Domain

IPC product domain under `PUB/ATDP/PRODUCTS`.

## Scope
This folder hosts IPC-specific publication assets and configuration.
...
## Governance
- IPC content is publication-layer output and must trace to SSOT/CSDB_REF lineage.
