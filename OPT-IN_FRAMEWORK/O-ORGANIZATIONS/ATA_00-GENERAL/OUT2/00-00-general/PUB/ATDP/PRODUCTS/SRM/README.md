# ATDP / PRODUCTS / SRM — Structural Repair Manual Domain

SRM product domain under `PUB/ATDP/PRODUCTS`.

## Scope
This folder hosts SRM-specific publication assets and configuration.
...
## Governance
- SRM content is publication-layer output and must trace to SSOT/CSDB_REF lineage.
