# ATDP / PRODUCTS / CMM — Component Maintenance Manual Domain

CMM product domain under `PUB/ATDP/PRODUCTS`.

## Scope
This folder hosts CMM-specific publication assets and configuration.
...
## Governance
- CMM content is publication-layer output and must trace to SSOT/CSDB_REF lineage.
