...
| Domain | Path | ATA Scope | Description |
|--------|------|-----------|-------------|
| **O-ORGANIZATIONS** | `O-ORGANIZATIONS/` | ATA 00–05 | Organizational and governance documentation |
| **P-PROGRAMS** | `P-PROGRAMS/` | ATA 06–12 | Program-level procedures and servicing |
